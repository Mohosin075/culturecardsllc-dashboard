...
export default function TermsAndConditionsPage() {
  ...
  useEffect(() => {
    async function fetchTerms() {
      try {
        const res = await api.legal.get("terms-and-condition");
        if (res && res.content) {
          setContent(res.content);
        }
      } catch (err) {
        console.error("Failed to load terms & conditions from API:", err);
      } finally {
        setLoading(false);
      }
    }
  ...
  const tocItems = [
    { id: "section-1", num: "01", title: "Eligibility & Accounts" },
    { id: "section-2", num: "02", title: "The AREIS Marketplace" },
    { id: "section-3", num: "03", title: "Buyer Terms & Bids" },
    { id: "section-4", num: "04", title: "Seller Commitments" },
    { id: "section-5", num: "05", title: "Livestreaming Rules" },
    { id: "section-6", num: "06", title: "Payments, Fees & Payouts" },
    { id: "section-7", num: "07", title: "Taxes & Reporting" },
    { id: "section-8", num: "08", title: "Prohibited Activities" },
    { id: "section-9", num: "09", title: "User Content Rights" },
    { id: "section-10", num: "10", title: "Privacy & Data Security" },
    { id: "section-11", num: "11", title: "Intellectual Property" },
    { id: "section-12", num: "12", title: "Third-Party Providers" },
    { id: "section-13", num: "13", title: "Suspension & Termination" },
    { id: "section-14", num: "14", title: "Platform Disclaimers" },
    { id: "section-15", num: "15", title: "Limitation of Liability" },
    { id: "section-16", num: "16", title: "Indemnification" },
    { id: "section-17", num: "17", title: "Dispute Resolution & Arbitration" },
    { id: "section-18", num: "18", title: "Governing Law (Florida)" },
    { id: "section-19", num: "19", title: "Changes to These Terms" },
    { id: "section-20", num: "20", title: "Contact AREIS LLC" },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0d14] text-zinc-100 selection:bg-blue-600 selection:text-white">
      ...
      <section className="relative overflow-hidden pt-8 sm:pt-16 pb-8 sm:pb-12 border-b border-white/10 bg-gradient-to-b from-[#111625] to-[#0a0d14]">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center space-y-4">
          ...
          <p className="text-zinc-400 text-base max-w-2xl mx-auto leading-relaxed">
            Please read these terms carefully before participating in the AREIS marketplace, bidding in auctions, or livestreaming content.
          </p>
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs text-zinc-400">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Governed by Florida Law, USA</span>
            </div>
            <div className="flex items-center gap-1.5">
      ...
      {/* User-Friendly Summary Highlights */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
          <div className="p-3.5 sm:p-5 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-blue-500/30 transition-all space-y-1.5 sm:space-y-2.5">
            ...
            <h3 className="font-semibold text-white text-xs sm:text-sm">Marketplace Platform</h3>
            <p className="text-[11px] sm:text-xs text-zinc-400 leading-relaxed line-clamp-3 sm:line-clamp-none">
              AREIS facilitates peer-to-peer commerce and livestreams. Transactions occur directly between buyer and seller.
            </p>
          </div>
          ...
          <div className="p-3.5 sm:p-5 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-blue-500/30 transition-all space-y-1.5 sm:space-y-2.5">
            ...
            <h3 className="font-semibold text-white text-xs sm:text-sm">Binding Auctions</h3>
            <p className="text-[11px] sm:text-xs text-zinc-400 leading-relaxed line-clamp-3 sm:line-clamp-none">
              Bids submitted on auction listings are binding purchase offers. Bid manipulation and shill bidding are prohibited.
            </p>
          </div>
          ...
          <div className="p-3.5 sm:p-5 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-blue-500/30 transition-all space-y-1.5 sm:space-y-2.5">
            ...
            <h3 className="font-semibold text-white text-xs sm:text-sm">Livestream Standards</h3>
            <p className="text-[11px] sm:text-xs text-zinc-400 leading-relaxed line-clamp-3 sm:line-clamp-none">
              Creators must comply with content policies. Unlawful, abusive, infringing, or counterfeit goods are strictly banned.
            </p>
          </div>
          ...
          <div className="p-3.5 sm:p-5 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-blue-500/30 transition-all space-y-1.5 sm:space-y-2.5">
            ...
            <h3 className="font-semibold text-white text-xs sm:text-sm">Dispute Arbitration</h3>
            <p className="text-[11px] sm:text-xs text-zinc-400 leading-relaxed line-clamp-3 sm:line-clamp-none">
              Claims are resolved through individual binding arbitration rather than class-action court litigation under Florida law.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 grid grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)] gap-6 lg:gap-10 items-start">
        ...
        <aside className="hidden lg:block sticky top-24 bg-[#111625]/90 border border-white/10 rounded-2xl p-6 backdrop-blur-md max-h-[calc(100vh-120px)] overflow-y-auto custom-scrollbar">
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <div className="text-xs text-zinc-400 mb-2">Legal inquiries?</div>
            <a
        ...
        <main className="bg-[#111625]/60 border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-12 shadow-2xl backdrop-blur-sm">
          {loading ? (
            ...
            <div className="py-16 text-center text-zinc-400">
              The Terms & Conditions document is currently being updated.
            </div>
          )}
          ...
          <div className="mt-14 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gradient-to-r from-blue-900/20 to-transparent p-6 rounded-2xl border border-blue-500/20">
            <div>
              <div className="text-[11px] font-bold uppercase tracking-wider text-blue-400">Related Policy</div>
              <h4 className="text-lg font-bold text-white mt-0.5">Privacy Policy</h4>
              <p className="text-xs text-zinc-400">Learn how AREIS collects, secures, and safeguards your data.</p>
            </div>
            <Link
              href="/privacy-policy"
