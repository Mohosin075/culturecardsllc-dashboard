          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/5 text-zinc-500 text-sm">
                <th className="px-6 py-4 font-medium text-xs uppercase tracking-wider">Order ID</th>
                <th className="px-6 py-4 font-medium text-xs uppercase tracking-wider">Buyer</th>
                <th className="px-6 py-4 font-medium text-xs uppercase tracking-wider">Seller</th>
                <th className="px-6 py-4 font-medium text-xs uppercase tracking-wider">Item</th>
                <th className="px-6 py-4 font-medium text-xs uppercase tracking-wider">Total Price</th>
                <th className="px-6 py-4 font-medium text-xs uppercase tracking-wider">Status</th>
                <th className="px-6 py-4 font-medium text-xs uppercase tracking-wider text-center">Delivery Date</th>
